...
[\citeonline{DeepLearningATA}], o que contrasta com a geral necessidade de etapas pré-processamento sobre os 
...
ResNet [\citeonline{ResNet}] e GoogLeNet [\citeonline{GooLeNet}]. Uma base de imagens utilizada por alguns desses trabalhos é o ImageNet 
