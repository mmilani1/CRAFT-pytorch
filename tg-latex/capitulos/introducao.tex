...
Em [\citeonline{KPN}], por exemplo, é proposta uma nova arquitetura de detecção, nomeada KPN (\textit{Kernel Proposal Network}) utilizando redes convolucionais e segmentação semântica para melhorar a detecção da fronteiras de palavras.
