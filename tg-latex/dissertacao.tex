...
\begin{siglas}
    ...
    \item[RPN] \textit{Region Proposal Network}
    \item[STN] \textit{Spatial Transform Network}
    \item[STR] \textit{Scene Text Recognition}
\end{siglas}
